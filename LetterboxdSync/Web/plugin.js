(function () {
    ...
    function openDialog() {
        ...
        var formHtml = [
            ...
            '      <input type="checkbox" id="lbxd-enable" class="emby-checkbox" />',
            ...
            '  <div class="checkboxContainer checkboxContainer-withDescription">',
            '    <label class="emby-checkbox-label" style="display:flex;align-items:center;gap:8px;">',
            '      <input type="checkbox" id="lbxd-sendfavorite" class="emby-checkbox" />',
            ...
            '  <div class="checkboxContainer checkboxContainer-withDescription">',
            '    <label class="emby-checkbox-label" style="display:flex;align-items:center;gap:8px;">',
            '      <input type="checkbox" id="lbxd-datefilter" class="emby-checkbox" />',
