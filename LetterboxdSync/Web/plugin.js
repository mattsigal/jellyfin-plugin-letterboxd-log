(function () {
    ...
    function openDialog() {
        ...
        var formHtml = [
            ...
            '    <label class="emby-checkbox-label" style="display:flex;align-items:center;gap:8px;">',
            '      <input type="checkbox" id="lbxd-enable" style="width:18px;height:18px;accent-color:#00a4dc;" />',
            ...
            '  <div class="checkboxContainer checkboxContainer-withDescription">',
            '    <label class="emby-checkbox-label" style="display:flex;align-items:center;gap:8px;">',
            '      <input type="checkbox" id="lbxd-sendfavorite" style="width:18px;height:18px;accent-color:#00a4dc;" />',
            ...
            '  <div class="checkboxContainer checkboxContainer-withDescription">',
            '    <label class="emby-checkbox-label" style="display:flex;align-items:center;gap:8px;">',
            '      <input type="checkbox" id="lbxd-datefilter" style="width:18px;height:18px;accent-color:#00a4dc;" />',
